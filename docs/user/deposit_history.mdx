...
این API برای دریافت لیست تاریخچه واریزهای ارز دیجیتال استفاده می‌شود. نتایج به صورت صفحه‌بندی شده برگردانده می‌شوند. برای استفاده از این API لازم است توکن احراز هویت در header ارسال شود.
