...
این API برای دریافت لیست تمام کیف پول‌های کاربر استفاده می‌شود. اطلاعات شامل موجودی، موجودی قفل شده، و ارزش تومانی و تتری دارایی‌ها است. برای استفاده از این API لازم است توکن احراز هویت در header ارسال شود.
...
این API برای دریافت اطلاعات جزئی یک کیف پول خاص استفاده می‌شود. این endpoint علاوه بر اطلاعات کیف پول، اطلاعات کامل شبکه‌های قابل استفاده برای واریز و برداشت را نیز برمی‌گرداند. برای استفاده از این API لازم است توکن احراز هویت در header ارسال شود.
...
این API برای دریافت سریع موجودی یک کیف پول خاص استفاده می‌شود. اطلاعات کمتری نسبت به endpoint بالا برمی‌گرداند و سریع‌تر است. برای استفاده از این API لازم است توکن احراز هویت در header ارسال شود.
