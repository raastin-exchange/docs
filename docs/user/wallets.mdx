...
این API برای دریافت لیست تمام کیف پول‌های کاربر استفاده می‌شود. اطلاعات شامل موجودی، موجودی قفل شده، و ارزش ریالی و تتری دارایی‌ها است.
...
### ارزش‌های محاسبه شده:
- `balance_irt`: ارزش موجودی به ریال (بر اساس آخرین قیمت بازار)
