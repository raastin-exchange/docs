...
این API برای ویرایش سفارش‌های باز (NEW یا PENDING) استفاده می‌شود. می‌توانید  مقدار یا قیمت یک سفارش را بدون لغو و ثبت مجدد آن تغییر دهید. برای استفاده از این API لازم است توکن احراز هویت در header ارسال شود.
