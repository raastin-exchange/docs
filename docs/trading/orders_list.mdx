...
این API برای دریافت لیست تمام سفارش‌های کاربر (فعال و تاریخچه) استفاده می‌شود. نتایج به صورت صفحه‌بندی شده (paginated) برگردانده می‌شوند. برای استفاده از این API لازم است توکن احراز هویت در header ارسال شود.
