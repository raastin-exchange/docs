...
برای ثبت سفارش معامله در بازار <ExchangeName />، از این API استفاده کنید. همچنین با ارسال درخواست **مشاهده وضعیت سفارش** می‌توانید از وضعیت سفارش خود مطلع شوید.

برای استفاده از این API، لازم است توکن احراز هویت خود را در بخش **Header** درخواست ارسال کنید.
...
| fill_type        | String  | ✓      | نوع اجرا: `limit`، `market`، `stop_loss` |
